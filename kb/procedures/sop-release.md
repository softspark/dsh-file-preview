...
8. Execute [the post-release SOP](sop-post-release-testing.md) against the exact npm artifact and record browser, authorization, signatures, and provenance results.
